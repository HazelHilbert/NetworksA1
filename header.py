...
def make_header_4(packet_type, producer_ID, stream_number, frame, crc_value):
    return struct.pack(get_header_format(packet_type), packet_type, producer_ID, stream_number, frame)
...
def get_header_format(header):
    ...
    if packet_type == 3 or packet_type == 4:
        header_format = 'b 3s'
    elif packet_type == 1 or packet_type == 5 or packet_type == 6:
        header_format = 'b 3s b'
    elif packet_type == 7: 
        header_format = 'b 3s b i'
